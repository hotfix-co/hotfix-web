...
const post = getBlogPost("kako-uvesti-ai-u-razvojni-proces")!;
...
export default async function AIAdoptionArticle({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const currentPost = getBlogPost("kako-uvesti-ai-u-razvojni-proces", loc) ?? post;
