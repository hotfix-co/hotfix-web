...
export default async function BlogPage({
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero Section */}
      <section className="gradient-mesh relative overflow-hidden pt-20 pb-14 md:pt-24 md:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="pill-tag-soft mb-6">{t("heroEyebrow")}</span>
            <h1 className="mb-5 text-[40px] font-light leading-[1.07] tracking-[-0.022em] text-[var(--ink)] text-balance md:text-[52px] md:leading-[1.05]">
              {t("heroTitle")}
            </h1>
            <p className="max-w-2xl text-[17px] leading-[1.5] text-[var(--ink-mute)]">
              {t("heroDesc")}
            </p>
          </div>
        </div>
            ...
            {sortedPosts.map((post) => {
              ...
              >
                <article className="card-feature-light flex h-full flex-col">
                  ...
                  <h2 className="mb-3 text-[22px] font-light leading-[1.2] tracking-[-0.015em] text-[var(--ink)] transition-colors group-hover:text-[var(--primary-deep)] md:text-[26px] md:leading-[1.15]">
                    {post.title}
                  </h2>
                  <p className="mb-6 line-clamp-3 text-[15px] leading-[1.5] text-[var(--ink-mute)]">
                    {post.excerpt}
                  </p>
                  <div className="mt-auto flex flex-wrap items-center gap-x-3 gap-y-1 text-[12px] text-[var(--ink-mute)]">
      ...
      <section className="bg-[var(--brand-dark-900)] py-20 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="mb-5 text-[36px] font-light leading-[1.1] tracking-[-0.022em] text-white text-balance md:text-[44px]">
            {t("ctaTitle")}
          </h2>
